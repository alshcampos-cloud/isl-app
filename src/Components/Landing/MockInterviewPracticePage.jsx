  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. The free tier includes 3 full AI mock interview sessions per month. No credit card is required to sign up. Upgrade to Pro for unlimited sessions at $29.99/month.',
        },
      },
      {
        '@type': 'Question',
        ...
        <section className="mb-16">
          ...
          <div className="space-y-3">
            ...
            <FAQItem
              ...
              answer="Yes. The free tier includes 3 full AI mock interview sessions per month. No credit card is required to sign up. Upgrade to Pro for unlimited sessions at $29.99/month."
            />
            <FAQItem
